...
- `git clone https://github.com/fullstack-69/auth-spa.git`
- Backend
  - `cd backend`
  - Fill in `.env`
  - `pnpm install`
...
- _On premise_
  ...
  - [AuthJS](https://authjs.dev/)
    - I used this [before](https://youtu.be/INIz-AZ9bR8?si=DzEbiAou2oq4_hy2&t=1842). Now, it is merged into `Better-Auth`.
...
- `git clone https://github.com/fullstack-69/auth-spa-better-auth.git`
- Backend
  - `cd backend`
  - Fill in `.env`
  - `pnpm install`
