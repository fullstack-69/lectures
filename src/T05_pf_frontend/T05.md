...
- `./src/App.ts` [(Link)](https://github.com/fullstack-69/pf-frontend/blob/main/src/App.min.tsx)
- Start
  - `pnpm run dev`
...
- `./src/App.ts` [(Link)](https://github.com/fullstack-69/pf-frontend/blob/main/src/App.tsx)
- Build
  - `pnpm run build`
- Preview
  - `pnpm run preview`
