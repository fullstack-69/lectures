...
- Fundamental skills are still important.
  - To find a good solution to complex problems
  - To spot bugs and improve the code
  - To be confident in the code that you are responsible for
  - To harness the power of AI to be more productive

---

# Software Engineers in an AI era

- You don't get these skills by using AI to write code for you.
  - You get these skills by writing code yourself, making mistakes, and learning from them.

> So, use AI wisely. Don't let it do all the work for you, especially when you're learning.
