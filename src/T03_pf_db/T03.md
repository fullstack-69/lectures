...
- `pnpm install -D drizzle-kit typescript tsx @types/node @tsconfig/node-lts @tsconfig/node-ts eol-converter-cli`
- `pnpm approve-builds`
...
- Files
  ...
  - 💾 `./.npmrc` from `./npmrc.example` [(Link)](https://github.com/fullstack-69/pf-db/blob/main/.npmrc.example) [(What?)](https://docs.npmjs.com/cli/v10/configuring-npm/npmrc)
