...
- Message broker : [BullMQ](https://bullmq.io/) + [Redis](https://redis.io/), [Kafka](https://kafka.apache.org/), [RabbitMQ](https://www.rabbitmq.com/)
...
- Challenges
  - Ensuring reliability and scalability > HA
