...
// Add this line to export the app for testing
export default app;
```
...
- `pnpm init`
- `pnpm install cypress typescript@6 dotenv @tsconfig/node-lts @tsconfig/node-ts @types/node`
...
> _As of July 2026, Typescript 7 does not work with the current version of Cypress (15.18.1). Therefore, we are using Typescript 6._
...
- The `cypress` type definitions are included in the `tsconfig.json` file to enable TypeScript support for Cypress tests.
  - This allows types of `cy` and `Cypress` to be recognized in the test files.
- The actual definition is located at `node_modules\cypress\types\cypress.d.ts`
...
- `./cypress/e2e/min.cy.ts` [(Link)](https://github.com/fullstack-69/pf-testing/blob/main/cypress/e2e/min.cy.ts)
...
- Enable reading `.env`
  - `./cypress.config.ts` [(Link)](https://github.com/fullstack-69/pf-testing/blob/main/cypress.config.ts)
- Spec files
  - `./cypress/e2e/backend.cy.ts` [(Link)](https://github.com/fullstack-69/pf-testing/blob/main/cypress/e2e/backend.cy.ts)
  - `./cypress/e2e/frontend.cy.ts` [(Link)](https://github.com/fullstack-69/pf-testing/blob/main/cypress/e2e/frontend.cy.ts)
