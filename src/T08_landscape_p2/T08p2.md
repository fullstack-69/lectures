...
- **Next.js default** is SSR, everything else is opt-in.
  - In V15 SSG/SSR is per route and is decided by the compiler (with exceptions).
  - In V16, with partial prerendering, SSG/SSR is per component and is decided by directives (`'use cache'`).
