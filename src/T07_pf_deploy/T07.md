...
[Github Repo](https://github.com/fullstack-69/pf-deploy)
...
- The `healthcheck` is used to check if the database is ready to accept connections.
...
- The `backend` service will wait for the database to be healthy before starting.
- This removes the race condition where the backend tries to connect to the database before it is ready.
...
![alt text](./img/paste-1783925671960.png)
