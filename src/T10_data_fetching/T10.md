...
- `git clone https://github.com/fullstack-69/df-backend.git`
- `pnpm i`
- `pnpm run dev`
...
- `git clone https://github.com/fullstack-69/df-spa.git`
- `cd df-spa`
...
- `git clone https://github.com/fullstack-69/df-nextjs.git`
- `cd df-nextjs`
- `pnpm i`
- `pnpm run dev`
...
- `git clone https://github.com/fullstack-69/df-sse-todo.git`
- `cd df-sse-todo`
